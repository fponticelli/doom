...
Main.__name__ = ["Main"];
Main.main = function() {
	var comments_0 = { author : "Pete Hunt", text : "This is one comment"};
	var comments_1 = { author : "Jordan Walke", text : "This is *another* comment"};
	var main = window.document.getElementById("content");
	var box = new CommentBox();
	box.mount(main).update("http://localhost:3000/api/comments");
};
var doom_Component = function() {
};
...
doom_Component.prototype = {
	...
	,render: function(state) {
		throw new thx_error_AbstractMethod({ fileName : "Component.hx", lineNumber : 13, className : "doom.Component", methodName : "render"});
	}
	,update: function(state) {
		var oldNode = this.node;
		var newNode = this.view(state);
		if(null == this.parent && null == this.element && null == oldNode) throw new thx_Error("component is not mounted",null,{ fileName : "Component.hx", lineNumber : 19, className : "doom.Component", methodName : "update"});
		if(null == oldNode) {
			this.element = doom_HtmlNode.toHtml(newNode);
			if(this.parent.nodeType == 1) this.parent.innerHTML = "";
	...
	,view: function(state) {
		...
		this.node = this.render(state);
		{
			...
			case 0:
				var events = _g[4];
				var m = function(e) {
					_g1.element = e.target;
					if(null == _g1.parent) _g1.parent = _g1.element.parentNode; else _g1.parent.appendChild(_g1.element);
				};
				if(__map_reserved.create != null?events.existsReserved("create"):events.h.hasOwnProperty("create")) {
					var old;
					old = __map_reserved.create != null?events.getReserved("create"):events.h["create"];
					if(__map_reserved.create != null) events.setReserved("create",function(e1) {
						old(e1);
						m(e1);
					}); else events.h["create"] = function(e1) {
						old(e1);
						m(e1);
					};
				} else if(__map_reserved.create != null) events.setReserved("create",m); else events.h["create"] = m;
				break;
			default:
			}
		}
...
Counter.__super__ = doom_Component;
Counter.prototype = $extend(doom_Component.prototype,{
	render: function(x) {
		var _g = this;
		...
		return doom__$Node_Node_$Impl_$.el("div",(function($this) {
			...
			if(__map_reserved["class"] != null) _g1.setReserved("class","counter"); else _g1.h["class"] = "counter";
			$r = _g1;
			return $r;
		}(this)),null,null,null,"count " + x);
	}
	,__class__: Counter
});
...
CommentBox.__name__ = ["CommentBox"];
CommentBox.__super__ = doom_Component;
CommentBox.prototype = $extend(doom_Component.prototype,{
	render: function(url) {
		return doom__$Node_Node_$Impl_$.el("div",(function($this) {
			var $r;
	...
	render: function(data) {
		...
		case 0:
			...
			return doom__$Node_Node_$Impl_$.el("div",(function($this) {
				var $r;
				var _g1 = new haxe_ds_StringMap();
				if(__map_reserved["class"] != null) _g1.setReserved("class","loading"); else _g1.h["class"] = "loading";
				$r = _g1;
				return $r;
			}(this)),null,null,null,"Loading ...");
		case 1:
			var msg = data[2];
			return doom__$Node_Node_$Impl_$.el("div",(function($this) {
				var $r;
				var _g2 = new haxe_ds_StringMap();
				if(__map_reserved["class"] != null) _g2.setReserved("class","error"); else _g2.h["class"] = "error";
				$r = _g2;
				return $r;
			}(this)),null,null,null,msg);
		case 2:
			var comments2 = data[2];
			return doom__$Node_Node_$Impl_$.el("div",(function($this) {
				var $r;
				var _g3 = new haxe_ds_StringMap();
				if(__map_reserved["class"] != null) _g3.setReserved("class","commentList"); else _g3.h["class"] = "commentList";
				$r = _g3;
				return $r;
			}(this)),null,comments2.map(function(comment) {
				return new Comment().view(comment);
			}));
		}
	}
...
CommentForm.__name__ = ["CommentForm"];
CommentForm.__super__ = doom_Component;
CommentForm.prototype = $extend(doom_Component.prototype,{
	render: function(_) {
		return doom__$Node_Node_$Impl_$.el("div",(function($this) {
			var $r;
			var _g = new haxe_ds_StringMap();
			if(__map_reserved["class"] != null) _g.setReserved("class","commentForm"); else _g.h["class"] = "commentForm";
			$r = _g;
			return $r;
		}(this)),null,null,null,"Hello, world! I am a CommentForm.");
	}
...
Comment.__super__ = doom_Component;
Comment.prototype = $extend(doom_Component.prototype,{
	render: function(comment) {
		return doom__$Node_Node_$Impl_$.el("div",(function($this) {
			var $r;
			var _g = new haxe_ds_StringMap();
			if(__map_reserved["class"] != null) _g.setReserved("class","comment"); else _g.h["class"] = "comment";
			$r = _g;
			return $r;
		}(this)),null,[doom__$Node_Node_$Impl_$.el("h2",(function($this) {
			var $r;
			var _g2 = new haxe_ds_StringMap();
			if(__map_reserved["class"] != null) _g2.setReserved("class","comment"); else _g2.h["class"] = "comment";
			$r = _g2;
			return $r;
		}(this)),null,null,null,comment.author),(function($this) {
			var $r;
			var content = Markdown.markdownToHtml(comment.text);
			$r = doom_NodeImpl.Raw(content);
			return $r;
		}(this))]);
	}
	,__class__: Comment
...
doom_HtmlNode.createElement = function(name,attributes,events,children) {
	...
	while( $it0.hasNext() ) {
		var key = $it0.next();
		el.setAttribute(key,__map_reserved[key] != null?attributes.getReserved(key):attributes.h[key]);
	}
	var $it1 = events.keys();
	while( $it1.hasNext() ) {
		var key1 = $it1.next();
...
doom_HtmlNode.applyPatch = function(patch,node) {
	{
		...
		case 0:
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 1:
			var n1 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n1,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 2:
			var n2 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n2,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 3:
			var n3 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n3,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 4:
		...
		case 5:
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n4,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 6:
			var n5 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n5,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 7:
			var n6 = _g;
			...
			case 1:
				var name3 = patch[2];
				doom_HtmlNode.removeEvent(node,name3);
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n6,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 8:
			var n7 = _g;
			...
			case 1:
				var name4 = patch[2];
				var handler = patch[3];
				doom_HtmlNode.addEvent(node,name4,handler);
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n7,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 9:
			...
			var el1 = doom_HtmlNode.createElement(name5,attributes1,events1,children1);
		...
		case 13:
			...
			case 8:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n8,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 14:
			var n9 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n9,null,{ fileName : "HtmlNode.hx", lineNumber : 116, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		}
	}
	...
	while(_g11 < _g2) {
		var i1 = _g11++;
		{
			...
			case 0:
				...
				var a1 = _g21[3];
				var n = _g21[2];
				result.push(doom_Patch.AddElement(n,a1,e,c));
				break;
			case 2:
				var t = _g21[2];
				result.push(doom_Patch.AddText(t));
				break;
			case 1:
				var t1 = _g21[2];
				result.push(doom_Patch.AddRaw(t1));
				break;
			case 3:
				var t2 = _g21[2];
				result.push(doom_Patch.AddComment(t2));
				break;
			case 4:
				break;
			}
...
doom__$Node_Node_$Impl_$.diff = function(this1,that) {
	...
	case 0:
		...
		case 0:
			...
			var a2 = that[3];
			var n2 = that[2];
			if(n1 != n2) return [doom_Patch.ReplaceWithElement(n2,a2,e2,c2)]; else {
				var c11 = this1[5];
				var e11 = this1[4];
				var a11 = this1[3];
				var c21 = that[5];
				var e21 = that[4];
				var a21 = that[3];
				return doom__$Node_Node_$Impl_$.diffAttributes(a11,a21).concat(doom__$Node_Node_$Impl_$.diffEvents(e11,e21)).concat(doom__$Node_Node_$Impl_$.diffNodes(c11,c21));
			}
			break;
		case 2:
			var t = that[2];
	...
	case 2:
		...
		case 0:
			...
			var a22 = that[3];
			var n21 = that[2];
			return [doom_Patch.ReplaceWithElement(n21,a22,e22,c22)];
		case 2:
			var t11 = this1[2];
			var t21 = that[2];
		...
		case 1:
			var t3 = that[2];
			return [doom_Patch.ReplaceWithRaw(t3)];
		case 3:
			var t4 = that[2];
			return [doom_Patch.ReplaceWithComment(t4)];
		case 4:
			return [doom_Patch.Remove];
		}
		break;
	case 3:
		...
		case 2:
			var t5 = that[2];
			return [doom_Patch.ReplaceWithText(t5)];
		case 1:
			var t6 = that[2];
	...
	case 4:
		...
		case 2:
			var t7 = that[2];
			return [doom_Patch.ReplaceWithText(t7)];
		case 1:
			var t8 = that[2];
			return [doom_Patch.ReplaceWithRaw(t8)];
		case 3:
			var t9 = that[2];
			return [doom_Patch.ReplaceWithComment(t9)];
		}
		break;
	default:
		switch(that[1]) {
...
var doom_NodeImpl = { __ename__ : ["doom","NodeImpl"], __constructs__ : ["Element","Raw","Text","Comment","Empty"] };
...
doom_Patches.toString = function(patch) {
	...
	case 3:
		...
		return "AddElement(" + name + ", " + attributes.toString() + ", " + e + ", " + Std.string(c) + ")";
	case 9:
		var children1 = patch[5];
		var events1 = patch[4];
		var attributes1 = patch[3];
		...
		return "ReplaceWithElement(" + name1 + ", " + attributes1.toString() + ", " + e1 + ", " + Std.string(c1) + ")";
	case 8:
		var handler = patch[3];
		var name2 = patch[2];
...
doom_XmlNode.applyPatch = function(patch,node) {
	{
		...
		case 0:
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 1:
			var n1 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n1,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 2:
			var n2 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n2,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 3:
			var n3 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n3,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 4:
		...
		case 5:
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n4,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 6:
			var n5 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n5,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 7:
			var n6 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n6,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 8:
			var n7 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n7,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 9:
			var children1 = patch[5];
		...
		case 13:
			...
			case 3:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n8,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		case 14:
			var n9 = _g;
			...
			case 0:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n9,null,{ fileName : "XmlNode.hx", lineNumber : 80, className : "doom.XmlNode", methodName : "applyPatch"});
			}
			break;
		}
	}
...
doom_XmlNode.attributesToString = function(attributes) {
	...
	while( $it0.hasNext() ) {
		var key = $it0.next();
		buf += " " + key + "=\"" + StringTools.replace(__map_reserved[key] != null?attributes.getReserved(key):attributes.h[key],"\"","&quot;") + "\"";
	}
	return buf;
};
...
thx__$Tuple_Tuple1_$Impl_$.of = function(_0) {
	return _0;
};
...
thx_http__$Headers_Headers_$Impl_$.set = function(this1,key,value) {
	var p = thx_http__$Headers_Headers_$Impl_$.getHeader(this1,key);
	if(null == p) thx_http__$Headers_Headers_$Impl_$.add(this1,key,value); else p._1 = thx_http__$Header_Header_$Impl_$.normalizeValue(value);
};
...
thx_load_Loader.makeTextHttpRequest = function(url) {
	return thx_promise__$Promise_Promise_$Impl_$.mapSuccessPromise(thx_http_Request.get(url),function(response) {
		...
		default:
			return thx_promise__$Promise_Promise_$Impl_$.fail(response.get_statusText(),{ fileName : "Loader.hx", lineNumber : 112, className : "thx.load.Loader", methodName : "makeTextHttpRequest"});
		}
	});
};
thx_load_Loader.makeBinaryHttpRequest = function(url) {
	return thx_promise__$Promise_Promise_$Impl_$.mapSuccessPromise(thx_http_Request.get(url),function(response) {
		...
		case 204:case 205:
			return thx_promise__$Promise_Promise_$Impl_$.value(null);
		default:
			return thx_promise__$Promise_Promise_$Impl_$.fail(response.get_statusText(),{ fileName : "Loader.hx", lineNumber : 126, className : "thx.load.Loader", methodName : "makeBinaryHttpRequest"});
		}
	});
};
thx_load_Loader.loadText = function(path) {
	return thx_promise__$Promise_Promise_$Impl_$.fail("this target doesn't support loading files from the filesystem",{ fileName : "Loader.hx", lineNumber : 137, className : "thx.load.Loader", methodName : "loadText"});
};
thx_load_Loader.loadBinary = function(path) {
	return thx_promise__$Promise_Promise_$Impl_$.fail("this target doesn't support loading files from the filesystem",{ fileName : "Loader.hx", lineNumber : 147, className : "thx.load.Loader", methodName : "loadBinary"});
};
