...
doom_Component.prototype = {
	...
	,updateNode: function(oldNode) {
		...
		case 4:
			break;
		default:
			throw new thx_Error("Component " + this.toString() + " must return only element nodes",null,{ fileName : "Component.hx", lineNumber : 27, className : "doom.Component", methodName : "updateNode"});
		}
...
var doom_ApiComponent = function(api,state) {
	this.api = api;
	doom_Component.call(this,state);
};
doom_ApiComponent.__name__ = ["doom","ApiComponent"];
doom_ApiComponent.__super__ = doom_Component;
doom_ApiComponent.prototype = $extend(doom_Component.prototype,{
	__class__: doom_ApiComponent
});
...
var doom_ApiStatelessComponent = function(api) {
	this.api = api;
	doom_StatelessComponent.call(this);
};
doom_ApiStatelessComponent.__name__ = ["doom","ApiStatelessComponent"];
doom_ApiStatelessComponent.__super__ = doom_StatelessComponent;
doom_ApiStatelessComponent.prototype = $extend(doom_StatelessComponent.prototype,{
	__class__: doom_ApiStatelessComponent
});
...
doom_HtmlNode.applyPatch = function(patch,node) {
	{
		...
		case 0:
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 1:
			var n1 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n1,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 2:
			var n2 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n2,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 3:
			var n3 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n3,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 4:
		...
		case 5:
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n4,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 6:
			var n5 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n5,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 7:
		...
		case 9:
			...
			parent2.replaceChild(dots_Html.parse(raw),node);
			break;
		case 10:
			var text4 = patch[2];
			var parent3 = node.parentNode;
			parent3.replaceChild(doom_HtmlNode.createComment(text4),node);
			break;
		case 11:
			var n6 = _g;
			switch(_g) {
			...
			case 8:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n6,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 12:
			var n7 = _g;
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + n7,null,{ fileName : "HtmlNode.hx", lineNumber : 135, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		}
	}
...
doom__$Node_Node_$Impl_$.diff = function(this1,that) {
	...
	case 4:
		...
		case 4:
			...
			tmp = doom__$Node_Node_$Impl_$.diff(old.node,comp.node);
			break;
		case 0:
...
doom_Patch.ReplaceWithRaw = function(raw) { var $x = ["ReplaceWithRaw",9,raw]; $x.__enum__ = doom_Patch; $x.toString = $estr; return $x; };
...
var todomvc_view_App = function(api) {
	doom_ApiStatelessComponent.call(this,api);
};
todomvc_view_App.__name__ = ["todomvc","view","App"];
todomvc_view_App.__super__ = doom_ApiStatelessComponent;
todomvc_view_App.prototype = $extend(doom_ApiStatelessComponent.prototype,{
	render: function() {
		var _g = this;
...
var todomvc_view_Body = function(api,state) {
	doom_ApiComponent.call(this,api,state);
};
todomvc_view_Body.__name__ = ["todomvc","view","Body"];
todomvc_view_Body.__super__ = doom_ApiComponent;
todomvc_view_Body.prototype = $extend(doom_ApiComponent.prototype,{
	render: function() {
		var tmp;
...
todomvc_view_Footer.__super__ = doom_ApiComponent;
todomvc_view_Footer.prototype = $extend(doom_ApiComponent.prototype,{
	render: function() {
		var tmp;
		var tmp3;
		var _g = new haxe_ds_StringMap();
...
var todomvc_view_Header = function(api) {
	doom_ApiStatelessComponent.call(this,api);
};
todomvc_view_Header.__name__ = ["todomvc","view","Header"];
todomvc_view_Header.__super__ = doom_ApiStatelessComponent;
todomvc_view_Header.prototype = $extend(doom_ApiStatelessComponent.prototype,{
	render: function() {
		var tmp;
		var tmp1;
		var _g = new haxe_ds_StringMap();
...
todomvc_view_Item.__super__ = doom_ApiComponent;
todomvc_view_Item.prototype = $extend(doom_ApiComponent.prototype,{
	render: function() {
		var tmp;
		var tmp1;
		var _g1 = new haxe_ds_StringMap();
	...
	,handleBlur: function() {
		...
		if(thx_Strings.isEmpty(value)) this.api.remove(); else this.api.updateText(value);
	}
...
todomvc_view_List.__super__ = doom_ApiComponent;
todomvc_view_List.prototype = $extend(doom_ApiComponent.prototype,{
	render: function() {
		var tmp;
		var tmp1;
		var _g = new haxe_ds_StringMap();
