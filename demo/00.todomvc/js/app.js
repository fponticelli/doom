...
doom_HtmlNode.applyPatch = function(patch,node) {
	{
		...
		case 0:
			...
			case 1:
				...
				break;
			default:
				throw new thx_Error("cannot apply patch " + Std.string(p) + " on " + Std.string(node),null,{ fileName : "HtmlNode.hx", lineNumber : 140, className : "doom.HtmlNode", methodName : "applyPatch"});
			}
			break;
		case 1:
			switch(_g) {
...
var doom_Patch = { __ename__ : true, __constructs__ : ["AddText","AddRaw","AddElement","AddComponent","MigrateElementToComponent","Remove","RemoveAttribute","SetAttribute","ReplaceWithElement","ReplaceWithText","ReplaceWithRaw","ReplaceWithComponent","ContentChanged","PatchChild"] };
