...
var doom_ComponentBase = function(children,doRender) {
	if(doRender == null) doRender = false;
	this.children = children;
	if(doRender) this.node = this.render();
};
...
doom_ComponentBase.prototype = {
	...
	,updateNode: function(oldNode) {
		...
		case 3:
			break;
		default:
			throw new thx_Error("Component " + this.toString() + " must return only element nodes",null,{ fileName : "ComponentBase.hx", lineNumber : 28, className : "doom.ComponentBase", methodName : "updateNode"});
		}
	...
	,render: function() {
		throw new thx_error_AbstractMethod({ fileName : "ComponentBase.hx", lineNumber : 37, className : "doom.ComponentBase", methodName : "render"});
	}
	,mount: function() {
	}
	,refresh: function() {
...
doom__$Node_Node_$Impl_$.diff = function(this1,that) {
	...
	case 3:
		switch(that[1]) {
		case 3:
			tmp = [doom_Patch.MigrateComponentToComponent(this1[2],that[2])];
			break;
		default:
			tmp = [doom_Patch.DestroyComponent(this1[2])];
		}
		break;
	default:
		switch(that[1]) {
...
todomvc_view_List.prototype = $extend(doom_Component.prototype,{
	render: function() {
		...
		while( $it0.hasNext() ) {
			...
			var tmp11;
			var f1 = [($_=this.api,$bind($_,$_.toggle))];
			var id1 = [item.id];
			tmp11 = (function(id1,f1) {
				return function() {
					f1[0](id1[0]);
				};
			})(id1,f1);
			var tmp12;
			var f2 = [($_=this.api,$bind($_,$_.updateText))];
			var id2 = [item.id];
			tmp12 = (function(id2,f2) {
				return function(a1) {
					f2[0](id2[0],a1);
				};
			})(id2,f2);
