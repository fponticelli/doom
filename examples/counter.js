...
CounterExample.__name__ = ["CounterExample"];
CounterExample.main = function() {
	Doom.browser.mount(doom_core_VNodeImpl.Comp(new ClickCounter({ clicks : 0})),window.document.querySelector("body"));
};
...
var ClickCounter = function(props,children) {
	doom_html_Component.call(this,props,children);
};
ClickCounter.__name__ = ["ClickCounter"];
ClickCounter.__super__ = doom_html_Component;
ClickCounter.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		var components;
		if(this.props.clicks == 0) {
			components = doom_core__$VNodes_VNodes_$Impl_$.children([doom_core__$VNode_VNode_$Impl_$.el("p",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Please click somewhere in this page",null,null)]))]);
		} else {
			var components1 = doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("Clicks " + Std.string(this.props.clicks),null,null)]));
			var _g = new haxe_ds_StringMap();
			var value = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("height: 30px");
			if(__map_reserved["style"] != null) {
				_g.setReserved("style",value);
			} else {
				_g.h["style"] = value;
			}
			var components2 = doom_core__$VNode_VNode_$Impl_$.el("div",_g,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("",null,null)]));
			var _g1 = new haxe_ds_StringMap();
			var value1 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("button");
			if(__map_reserved["type"] != null) {
				_g1.setReserved("type",value1);
			} else {
				_g1.h["type"] = value1;
			}
			var f = $bind(this,this.reset);
			var value2 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el,e) {
				e.preventDefault();
				var value3 = dots_Dom.getValue(el);
				f(value3);
			});
			if(__map_reserved["click"] != null) {
				_g1.setReserved("click",value2);
			} else {
				_g1.h["click"] = value2;
			}
			components = doom_core__$VNodes_VNodes_$Impl_$.children([components1,components2,doom_core__$VNode_VNode_$Impl_$.el("button",_g1,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("reset counter",null,null)]))]);
		}
		var _g2 = new haxe_ds_StringMap();
		var value4 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromString("position:fixed; top:0px; left:0px; width:100%; height:100%;");
		if(__map_reserved["style"] != null) {
			_g2.setReserved("style",value4);
		} else {
			_g2.h["style"] = value4;
		}
		...
		var value5 = doom_core__$AttributeValue_AttributeValue_$Impl_$.fromEventHandler(function(el1,e1) {
			e1.preventDefault();
			var value6 = dots_Dom.getValue(el1);
			f1(value6);
		});
		if(__map_reserved["click"] != null) {
			_g2.setReserved("click",value5);
		} else {
			_g2.h["click"] = value5;
		}
		var mainNode = doom_core__$VNode_VNode_$Impl_$.el("div",_g2,components);
		return mainNode;
	}
	,onClick: function(e) {
		this.update(thx_Objects.shallowCombine(this.props,{ clicks : this.props.clicks + 1}),{ fileName : "CounterExample.hx", lineNumber : 49, className : "ClickCounter", methodName : "onClick"});
	}
	,reset: function(e) {
		haxe_Log.trace("Setting counter back to 0!",{ fileName : "CounterExample.hx", lineNumber : 57, className : "ClickCounter", methodName : "reset"});
		this.update(thx_Objects.shallowCombine(this.props,{ clicks : 0}),{ fileName : "CounterExample.hx", lineNumber : 58, className : "ClickCounter", methodName : "reset"});
